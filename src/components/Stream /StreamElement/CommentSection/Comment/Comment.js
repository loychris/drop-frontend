...
const COLOR_COMMENT_BACKGORUND_SELECTED = 'rgba(100, 0, 0, 0.6)';
...
class Comment extends Component {
  ...
  SpeechBubbleArrow = (color) => {
    ...
    >
      <path
        ...
        fill= {!this.state.selected ? COLOR_COMMENT_BACKGROUND : COLOR_COMMENT_BACKGORUND_SELECTED}
      />
    </svg>)
  };
  ...
  render() {
    ...
    const backgorundStyle = !this.state.selected ? { backgroundColor: COLOR_COMMENT_BACKGROUND } : { backgroundColor: COLOR_COMMENT_BACKGORUND_SELECTED }
    return (
      <div className={classes.CommentContainer}>
        <div className={classes.Comment} style={commentStyle}>
          <AuthorPic depth={this.props.depth} indent={INDENT} />
          <div
            className={classes.CommentBackground}
